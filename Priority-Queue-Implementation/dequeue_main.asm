...
.half 8
.half 10
.word p00, p03, p01, p04, p07, p06, p02, p05, 0, 0,	# Swapping twice					WORKED
#.word p00, p03, 0, 0, 0, 0, 0, 0, 0, 0,	# Have no children after removing			WORKED
#.word p00, p01, p03, 0, 0, 0, 0, 0, 0, 0,	# Have one child after removing				WORKED	
#.word p00, p03, p01, p04, 0, 0, 0, 0, 0, 0,		# Have two children. Need to swap once	WORKED
v0: .asciiz "v0: "
...
move $a0, $s0	# printing out the answer packet
jal print_packet
li $a0, '\n'
li $v0, 11
syscall
